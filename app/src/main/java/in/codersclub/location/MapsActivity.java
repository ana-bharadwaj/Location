package in.codersclub.location;
...
import in.codersclub.location.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextLatitude = findViewById(R.id.editTextTextPersonName3);
        editTextLongitude = findViewById(R.id.editTextTextPersonName4);
